...
export default function Contact() {
  ...
  return (
    <div className='pt-20 w-full h-full'>
        <h1 className='text-center text-3xl pb-8 underline font-logo'> Contact Us </h1>
        <form method='POST' action="https://formspree.io/f/xdornrqb"
        className='flex flex-col max-w-4xl justify-center border border-black rounded p-4 mx-4'>
