  ...
  return (
    <section className='pt-20 flex justify-center'>
      <div className='px-10 flex flex-col items-start gap-7 max-w-4xl border-l ml-2 border-black'>
        <h1 className='font-logo text-4xl underline lg:text-5xl'>About</h1>

        <div className='container-about'>
          <h2 className='subtitle-about'>Source Code: </h2>
          <a className='text-blue-500 underline hover:text-purple-500 lg:text-lg' href='https://github.com/LeeBingler/ReactShop'> ReactShop </a>
        </div>
        ...
        <div className='flex flex-col gap-10'>
          ...
          <div className='container-about'>
            <h2 className='subtitle-about'> Documentation librairie and framework used :</h2>
